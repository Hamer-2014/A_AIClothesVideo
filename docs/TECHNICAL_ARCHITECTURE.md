...
3. 提交 EvoLink `veo3.1-fast-beta` 异步生成任务。
...
| `video_generation` | EvoLink `veo3.1-fast-beta` | MVP 主视频模型 |
...
- EvoLink `veo3.1-fast-beta` 的实测时长、价格、失败率。
