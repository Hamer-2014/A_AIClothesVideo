...
const content = {
  en: {
    ...
    sections: [
      ...
      ["Cloudflare R2", "Uploaded images, video segments, final videos, covers, and quality-check frames are stored in private Cloudflare R2 object storage. Access uses short-lived signed URLs; the bucket is not a public directory."],
  ...
  "zh-CN": {
    ...
    sections: [
      ...
      ["Cloudflare R2", "上传图片、视频分段、最终视频、封面和质检帧存储在私有 Cloudflare R2 对象存储中。访问使用短时效签名 URL，存储桶不是公开目录。"],
