...
const homeCopy = {
  en: {
    ...
    evidence: {
      kicker: "01 / One garment, three appearance references",
      title: "Each verified view defines what motion may show",
      body: "The front, side, and back appearance references lock the visible adult model, garment construction, and supported pose range. Missing or unverified views narrow the shot list instead of inviting the model to invent motion.",
      sampleTitle: "An approved 8-second excerpt from the real workflow",
      disclaimer: "The garment input was synthetic, and these appearance references were generated by the real virtual-try-on workflow. The public video is the manually approved front-facing segment; the 24-second version is not used on the public site because its turn exceeded the supported motion range.",
  ...
  "zh-CN": {
    ...
    evidence: {
      kicker: "01 / 同一件服装，真人定妆三视图",
      title: "每个核验视角都限定视频动作边界",
      body: "正、侧、背定妆参考锁定可见成人模特、服装结构与可用姿态范围。素材缺失或未通过核验时，系统会收窄镜头，而不是补画不存在的动作。",
      sampleTitle: "真实工作流中通过人工复核的 8 秒精选片段",
      disclaimer: "服装输入为合成素材，真人定妆三视图由真实虚拟试穿链路生成。公开视频仅使用通过人工复核的正面镜头；24 秒完整版不用于公开展示，因为其中的转身超出了素材支持范围。",
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--ink)]">
      ...
      <section className="landing-hero" aria-labelledby="landing-title">
        <SampleVideo autoPlay className="landing-hero-video landing-hero-video-portrait" language={locale} sourcePage="homepage" testId="landing-hero-video" />
      ...
      <section className="bg-[var(--surface-raised)]" id="source-proof">
        <div className="mx-auto max-w-7xl px-5 py-18 sm:px-8 lg:px-12 lg:py-28">
          ...
          <div className="mt-12 grid gap-7 border-t border-[var(--line-strong)] pt-8 lg:grid-cols-[0.65fr_1.35fr]">
            ...
            <div className="relative aspect-[9/16] w-full max-w-md justify-self-end overflow-hidden bg-black"><SampleVideo ariaLabel={copy.evidence.videoLabel} className="size-full object-contain" controls language={locale} sourcePage="homepage" /></div>
          </div>
        </div>
      </section>
