...
const env = { APIMART_API_KEY: "key", CLOUDFLARE_R2_ACCOUNT_ID: "id", CLOUDFLARE_R2_ACCESS_KEY_ID: "access", CLOUDFLARE_R2_SECRET_ACCESS_KEY: "secret", CLOUDFLARE_R2_BUCKET: "bucket", VIRTUAL_TRYON_MODEL_BASE_KEY: "models/virtual-try-on/default-v1", VIRTUAL_TRYON_FRONT_ONLY_CREDIT_COST: "2", VIRTUAL_TRYON_THREE_VIEW_CREDIT_COST: "5", VISION_PROVIDER: "openai", VISION_API_KEY: "vision", VISION_MODEL_STRICT: "strict", PROMPT_MODERATION_MODE: "off", APP_ENV: "development", NODE_ENV: "test" };
